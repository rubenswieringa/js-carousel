...
(function() {
  ...
  this.Carousel = (function() {
    ...
    function Carousel(element, options) {
      var auto, nextButton, prevButton, _ref;
      ...
      this.currentIndex = 0;
      this.slideSelector = options.slideSelector || '>img';
      this.slides = this.element.find("" + this.slideSelector);
      ...
      auto = options.auto === true ? Carousel.DEFAULT_INTERVAL : options.auto;
      if (auto) {
        this.interval = setInterval(this.next, auto);
      }
    }
    ...
    Carousel.prototype.add = function(slide) {
      ...
      lastSlide = this.element.find("" + this.slideSelector + ":last");
